# RailsAdmin config file. Generated on March 19, 2013 16:08
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Radar', 'Admin']
  ...
  # config.excluded_models = ['Item', 'Status', 'Theme']

  # Include specific models (exclude the others):
  # config.included_models = ['Item', 'Status', 'Theme']
